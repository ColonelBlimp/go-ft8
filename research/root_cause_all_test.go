...
var allCaptures = []captureSpec{
	{
		...
		Refs: []refSignal{
			{"SV2SIH ES2AJ -16", 1860.5, 0.000, false},
			{"VE1WT K4GBI 73", 1309.9, 0.140, false},
			{"SV2SIH KI8JP -10", 1902.9, 0.030, false},
			{"CQ PV8AJ FJ92", 1691.8, 0.000, true},
			{"<...> RA1OHX KP91", 2098.6, 0.090, false},
			{"KB7THX WB9VGJ RR73", 2328.0, 0.300, false},
			{"A61CK UA1CEI KP50", 948.2, 0.000, false},
			{"<...> LU3DXU GF05", 1273.0, 0.400, false},
			{"<...> RA6ABC KN96", 1814.0, 0.300, false},
			{"ES2AJ UA3LAR KO75", 835.0, 0.400, false},
			{"A61CK W3DQS -12", 579.1, 0.050, false},
			{"HZ1TT RU1AB R-10", 2208.4, 1.080, false},
			{"<...> RV6ASU KN94", 460.9, 0.180, false},
		},
	},
	{
		Name:    "Capture 2",
		...
		Refs: []refSignal{
			{"HA5LB 5B4AMX RR73", 815.6, 2.460, false},
			{"CQ ZS4AW KG31", 1776.0, 1.850, true},
			{"CQ SV0TPN KM28", 2100.0, 1.860, true},
			{"CQ Z62NS KN02", 745.6, 1.810, true},
			{"VK/ZL4XZ <...> RR73", 331.8, 1.820, false},
			{"VK3ZSJ YO8RQP KN37", 862.5, 1.860, false},
			{"R1QD KB2ELA -12", 1463.8, 1.810, false},
			{"UY7VV KE6SU DM14", 553.0, 1.800, false},
			{"TL8GD UT2VX KN69", 319.0, 1.800, false},
			{"RU4LM 4X5JK R-14", 1840.0, 1.800, false},
			{"JT1CO IZ7DIO 73", 1768.0, 1.800, false},
			{"VK3ZSJ US7KC KO21", 1502.0, 1.800, false},
			{"JR3UIC SP7IIT RR73", 1410.0, 1.800, false},
			{"JT1CO YO3HST KN24", 1096.0, 1.800, false},
			{"CQ TN8GD JI75", 451.0, 1.800, true},
			{"CQ HA1BF JN86", 1272.0, 1.800, true},
			{"UA4CCH VK2VT RR73", 2593.0, 1.900, false},
		},
	},
	{
		Name:    "Capture 3",
		...
		Refs: []refSignal{
			{"VK5BU RT6C KN95", 2454, 1.8, false},
			{"CQ V4/SP9FIH", 298, 1.8, true},
			{"A61OK US1VM KN68", 568, 2.0, false},
			{"CQ KB3Z FN20", 1100, 2.0, true},
			{"CQ NH6D BL02", 2251, 1.9, true},
			{"VK3TZ UX2QX R-07", 1776, 1.8, false},
			{"UB8CSR SV0TPN -18", 1998, 2.2, false},
			{"R8AGW VU2FR RR73", 2507, 2.5, false},
			{"<...> JA8RVP QN23", 1001, 1.9, false},
			{"CQ UR5QW KN77", 2401, 1.9, true},
			{"UA0LW RK6AAC KN95", 1149, 2.1, false},
			{"CQ SP4MSY KO13", 1250, 1.7, true},
			{"VK5ATH VK0DS -01", 1648, 1.9, false},
			{"VK5BU RG5A KN93", 533, 1.9, false},
			{"5Z4VJ YB1RUS OI33", 1505, 1.8, false},
			{"UA0LW UA4ARH -15", 1211, 2.0, false},
			{"VK5BU R7HL 73", 2110, 1.8, false},
			{"CQ 4S6ARW MJ97", 938, 2.3, true},
			{"CQ CO8LY FL20", 932, 1.7, true},
			{"VK3TZ UA3ZNQ KO81", 888, 2.1, false},
			{"VK3TZ RC7O KN87", 963, 1.9, false},
		},
	},
}
